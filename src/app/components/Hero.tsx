        ...
        <div className="w-full md:w-1/2 mb-10 md:mb-0 flex flex-col items-center">
          ...
          <div className="flex space-x-4 mt-6">
            <a
              ...
              className="text-gray-700 dark:text-gray-300 hover:text-blue-700 transition duration-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-700 dark:text-gray-300 hover:text-gray-900 transition duration-300"
            >
              <FaGithub className="h-8 w-8" />
            </a>
            <a
              href="mailto:lucanoliveira@gmail.com"
              className="text-gray-700 dark:text-gray-300 hover:text-red-600 transition duration-300"
            >
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-0 mt-10">
            {displayedSkills.map((skill) => (
              <div
                key={skill}
                className="flex items-center border p-3 lg:p-4 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-300 dark:border-gray-600"
              >
                <div className="mr-3 rounded-full shadow-sm">
                  {skillIcons[skill as SkillIconKeys]}
                </div>
                <p className="text-sm md:text-md lg:text-lg font-semibold text-gray-700 dark:text-gray-300">
                  {skill}
                </p>
              </div>
            ))}
