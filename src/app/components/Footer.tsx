            ...
            <div className="container mx-auto px-6 md:px-8 lg:px-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <p className="text-center md:text-left text-gray-400 text-lg md:text-base">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <nav className="flex flex-col space-y-2">
                            <Link href="#about" className="hover:text-white transition-colors duration-300 text-lg md:text-base">
                                {translations.about}
                            </Link>
                            <Link href="#projects" className="hover:text-white transition-colors duration-300 text-lg md:text-base">
                                {translations.projects}
                            </Link>
                            <Link href="#contact" className="hover:text-white transition-colors duration-300 text-lg md:text-base">
