...
export const jp = {
    ...
    readOnline: "オンラインで読む",
    heroDescription: "私はソフトウェアエンジニアとして3年以上の経験があり、さまざまな業界で効率的かつスケーラブルなアプリケーションを開発してきました。フロントエンドとバックエンドの両方を専門とし、ビジネスにインパクトを与える高性能なシステムを構築しています。常に自分のスキルを高める新たな挑戦を求めています。",
    getInTouch: "お問い合わせ",
    experience: "経験",
    showMore: "もっと見る",
    showLess: "少なくする",
