...
export const jp = {
    ...
    experienceDescription: "業界での2年間の経験により、モダンなウェブ技術におけるスキルを向上させるためにさまざまなプロジェクトに貢献してきました。",
    awards: "賞と表彰",
    awardsDescription: "オープンソースプロジェクトおよびコミュニティイニシアチブへの貢献に対して表彰されています。",
    ...
    thankYouMessage: "メッセージをありがとうございます！",
    quickLinks: "クイックリンク",
    contactUs: "お問い合わせ",
    contactMessage: "ぜひご連絡ください！プロジェクトのアイデアがある場合、コラボレーションしたい場合、またはただ挨拶したい場合でも、お気軽にお声がけください。一緒に素晴らしいものを作りましょう。",
