...
experiences: [
  {
    ...
    role: "Analista de Engenharia de Software Personalizado",
    techStack: [
      "Python",
      "Flask",
      "JavaScript",
    ...
    endDate: "Atual",
    description: `
• Desenvolvi automações inteligentes usando Pipefy para otimizar fluxos de trabalho e aumentar a eficiência operacional.
• Melhorei continuamente scripts de automação com foco em desempenho, escalabilidade e legibilidade do código.
• Projetei e mantive arquiteturas modernas, seguras e alinhadas ao mercado, garantindo manutenibilidade e confiabilidade.
• Colaborei com equipes distribuídas utilizando Git, metodologias ágeis (Scrum/Kanban) e ferramentas de controle de tarefas e versões.
• Criei e mantive RPAs e rotinas de web scraping, automatizando processos críticos e reduzindo custos operacionais.
• Desenvolvi sistemas backend em Python, seguindo princípios de clean code e melhores práticas.
• Mantive e otimizei sistemas voltados ao RH, melhorando operações internas e a experiência do usuário.
• Desenvolvi interfaces frontend com Angular e implementei backends serverless com Python e Google Cloud Functions.
• Utilizei o Podman para containerizar e gerenciar serviços em ambientes escaláveis.
    `,
  },
  {
    ...
    endDate: "Jan 2025",
    description: `
• Contribuí para o desenvolvimento e manutenção de aplicações web voltadas ao comércio de energia e operações de varejo, otimizando ferramentas internas.
• Ajudei a reduzir os tempos de resposta de APIs em até 30% por meio de otimizações com FastAPI, técnicas de cache e programação assíncrona.
• Auxiliei na migração de componentes legados para ambientes containerizados usando Docker e Docker Compose, reduzindo problemas de ambiente em 40%.
• Colaborei no desenvolvimento frontend, resultando em uma melhoria de 15% na satisfação dos usuários com base em feedback interno.
• Apoiei a equipe na identificação e correção de bugs, contribuindo para uma redução de 20% nos incidentes pós-deploy.
    `,
  },
  {
    ...
    endDate: "Ago 2024",
    description: `
• Contribuí no desenvolvimento de serviços backend em Python (Django, Flask, FastAPI), trabalhando com outros engenheiros para entregar APIs escaláveis e bem testadas.
• Auxiliei no desenvolvimento e manutenção de funcionalidades frontend com React, TypeScript, Material UI e Styled Components, melhorando a consistência e a responsividade da interface.
• Colaborei em projetos com comunicação em tempo real via WebSockets e Socket.io, aumentando a interatividade do sistema.
• Trabalhei com APIs SOAP/REST e serviços externos para integrar fontes de dados financeiros aos sistemas internos.
• Participei da containerização de serviços com Docker, Docker Compose e setups básicos de Kubernetes para ambientes de desenvolvimento.
• Gerenciei e consultei bancos de dados relacionais e não-relacionais, como PostgreSQL, MySQL e MongoDB.
• Contribuí no deploy de aplicações usando AWS EC2, S3 e RDS, reduzindo o tempo de implantação em ~30% com scripts de automação.
• Trabalhei em equipe ágil reduzida, ajudando a entregar mais de 10 funcionalidades e correções durante o projeto.
• Escrevi testes unitários para serviços backend, aumentando a confiabilidade do código e contribuindo com até 15% de aumento na cobertura de testes em alguns módulos.
    `,
  },
  {
    ...
    endDate: "Dez 2024",
    description: `
• Desenvolvimento de aplicações em React.js
• Projeto, implementação e manutenção de APIs com JavaScript, Node.js e Django, incluindo APIs RESTful
• Criação, modelagem e administração de bancos de dados PostgreSQL
• Utilização do Postman para testes de API
• Configuração de servidor VPS Linux para hospedar aplicações React com backend Django usando Nginx
...
• Análise de performance e implementação de estratégias de SEO
    `,
  },
  {
    company: "Fundação de Rotarianos de São Paulo",
    logo: "/img/company_logos/fundacao_rotarianos_sp_logo.jpeg",
    role: "Analista de TI / Desenvolvedor de Automação",
    techStack: [
      "JavaScript",
      "HTML",
      "CSS",
    ...
    endDate: "Out 2023",
    description: `
• Desenvolvi scripts em Python e PowerShell para automatizar tarefas como instalação, configuração e gerenciamento de computadores. Essas automações reduziram o tempo de setup de mais de uma hora para menos de 15 minutos.
• Auxílio e orientação aos usuários no uso de ferramentas de TI.
• Suporte a usuários com problemas de internet.
• Apoio ao uso de e-mails internos e externos.
• Assistência na manutenção de sistemas.
• Instalação de impressoras físicas e em rede via servidor.
• Proficiente em sistemas operacionais Linux, Windows e Mac OS.
