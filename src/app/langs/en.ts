...
export const en = {
  ...
  experienceDescription: "With 2 years in the industry, I have contributed to various projects, enhancing my skills in modern web technologies.",
  awards: "Awards & Recognition",
  awardsDescription: "I have received accolades for my contributions to open-source projects and community initiatives.",
  ...
  contactMessage: "I'd love to hear from you! Whether you have a project in mind, want to collaborate, or just want to say hi, feel free to reach out. Let's create something amazing together.",
